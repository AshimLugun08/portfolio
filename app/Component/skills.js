...
export const Skills = () => {
  ...
  useGSAP(() => {
    gsap.from(".scrolleffet", {
      ...
      scrollTrigger: {
        trigger: ".scrolleffet", scroller: "body", start: "top 80%",
      },
    });
    gsap.from(".scrolleffet1", {
      y: 40, opacity: 0, duration: 1,
      scrollTrigger: {
        trigger: ".scrolleffet1", scroller: "body", start: "top 80%",
      },
    });
    gsap.from(".scrolleffet2", {
      y: 40, opacity: 0, duration: 1,
      scrollTrigger: {
        trigger: ".scrolleffet2", scroller: "body", start: "top 80%",
      },
    });
    gsap.from(".scrolleffet3", {
      y: 40, opacity: 0, duration: 1,
      scrollTrigger: {
        trigger: ".scrolleffet3", scroller: "body", start: "top 80%",
      },
    });
    gsap.from(".scrolleffet4", {
      y: 40, opacity: 0, duration: 1,
      scrollTrigger: {
        trigger: ".scrolleffet4", scroller: "body", start: "top 80%",
      },
    });
    gsap.from(".scrolleffet5", {
      y: 40, opacity: 0, duration: 1,
      scrollTrigger: {
        trigger: ".scrolleffet5", scroller: "body", start: "top 80%",
      },
    });
  }, []);
  ...
  return (
    <div className='bg-gray-200 md:mx-4 border rounded-t-2xl'>
      <div className='scrolleffet font-bold text-gray-700 font-sans mb-8 justify-center flex text-4xl'>
        Skills
      </div>
      <div className="min-h-80 md:h-auto flex flex-col items-center justify-center space-y-4">
        ...
        <div className='scrolleffet2 font-bold text-center flex flex-col items-center text-gray-700 font-sans text-2xl'>
        ...
        <div className="scrolleffet6 w-full flex justify-center space-x-2 sm:space-x-4">
          {imageUrls.slice(8, 12).map((url, index) => (
            <div key={index} className="relative w-16 h-16 sm:w-24 sm:h-24 md:w-32 md:h-32">
              <Image src={url} alt={`Image ${index + 9}`} layout="fill" objectFit="cover" />
            </div>
          ))}
        </div>
      </div>
